    ...
    void FixedUpdate()
    {
        if (isMoving)
        {
            ...
            if (Vector2.Distance(lastPosition, block.position) < blockSpeed * Time.deltaTime / 2 && firstFrame)
            {
                ...
                if (rb.gameObject.transform.localScale.y > rb.gameObject.transform.localScale.x)
                {
                ...
                } else if (rb.gameObject.transform.localScale.y < rb.gameObject.transform.localScale.x)
                {
